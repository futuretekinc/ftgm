...
typedef	FTM_RET	(*FTM_OM_SERVICE_INIT)(FTM_OM_PTR pOM, FTM_VOID_PTR pData);
...
FTM_RET	FTM_OM_SERVICE_init(FTM_OM_PTR pOM, FTM_OM_SERVICE_PTR pServices, FTM_ULONG ulCount);
