...
int main(int nArgc, char *pArgv[])
{
	...
	FTM_TRACE_setInfo2( FTM_TRACE_MODULE_ALL,		"ALL", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	//FTM_TRACE_setModule(0, FTM_TRUE);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_FTOM,		"FTOM", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_NODE,		"NODE", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_EP,		"EP", 		FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_TRIGGER,	"TRIGGER", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_ACTION,	"ACTION", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_RULE,		"RULE", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);

	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_DMC,		"DMC", 		FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);

	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_SNMPC,	"SNMPC", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_SNMPTRAP,	"SNMPTRAP", FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);

	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_MQTTC,	"MQTTC", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_DISCOVERY,"DISCOVERY",FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_SERVER,	"SERVER",	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	...
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_SHELL,	"SHELL", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
