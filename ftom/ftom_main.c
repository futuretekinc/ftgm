...
int main(int nArgc, char *pArgv[])
{
	...
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_NODE,		FTM_FALSE, "NODE", 		FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_EP,		FTM_FALSE, "EP", 		FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	...
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_SNMPC,	FTM_FALSE, "SNMPC", 	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
	...
	FTM_TRACE_setInfo2( FTOM_TRACE_MODULE_DISCOVERY,FTM_FALSE, "DISCOVERY",	FTM_TRACE_LEVEL_TRACE, FTM_TRACE_OUT_TERM);
