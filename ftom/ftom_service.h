...
typedef	FTM_RET	(*FTOM_SERVICE_CB)(FTOM_SERVICE_ID xID, FTOM_MSG_TYPE xMsg, FTM_VOID_PTR pData);
typedef	FTM_RET	(*FTOM_SERVICE_SET_CB)(FTM_VOID_PTR pData, FTOM_SERVICE_ID xID, FTOM_SERVICE_CB fCB);
...
typedef	struct
{
	...
	FTOM_SERVICE_SET_CB			fSetCallback;
	FTOM_SERVICE_CB				fCallback;
