...
typedef	FTM_RET		(*FTOM_NODE_GET_EP_UPDATE_INTERVAL)(struct FTOM_NODE_STRUCT _PTR_ pNode, FTM_EP_TYPE xType, FTM_ULONG ulIndex, FTM_ULONG_PTR pulUpdateInterval);
...
typedef struct FTOM_NODE_CLASS_STRUCT
{
	...
	FTOM_NODE_GET_EP_UPDATE_INTERVAL	fGetEPUpdateInterval;
