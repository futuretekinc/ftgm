...
FTM_RET	FTM_OM_ACTIONM_create
(
	FTM_OM_ACTIONM_PTR _PTR_ ppActionM
);

FTM_RET	FTM_OM_ACTIONM_destroy
(
	FTM_OM_ACTIONM_PTR _PTR_ ppActionM
);

FTM_RET	FTM_OM_ACTIONM_init
(
	FTM_OM_ACTIONM_PTR pActionM
);

FTM_RET	FTM_OM_ACTIONM_final
(
	FTM_OM_ACTIONM_PTR pActionM
);

FTM_RET	FTM_OM_ACTIONM_loadConfig
(
	FTM_OM_ACTIONM_PTR 			pActionM, 
	FTM_OM_ACTIONM_CONFIG_PTR 	pConfig
);

FTM_RET	FTM_OM_ACTIONM_loadConfigFromFile
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_CHAR_PTR 		pFileName
);

FTM_RET	FTM_OM_ACTIONM_start
(
	FTM_OM_ACTIONM_PTR	pActionM
);

FTM_RET	FTM_OM_ACTIONM_stop
(
	FTM_OM_ACTIONM_PTR	pActionM
);

FTM_RET	FTM_OM_ACTIONM_add
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_ACTION_PTR 		pInfo
);

FTM_RET	FTM_OM_ACTIONM_del
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_ACTION_ID  		xActorID
);

FTM_RET	FTM_OM_ACTIONM_count
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_ULONG_PTR 		pulCount
);

FTM_RET	FTM_OM_ACTIONM_get
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_ACTION_ID 		xActorID, 
	FTM_OM_ACTION_PTR _PTR_ ppActor
);

FTM_RET	FTM_OM_ACTIONM_getAt
(
	FTM_OM_ACTIONM_PTR 	pActionM, 
	FTM_ULONG 			ulIndex, 
	FTM_OM_ACTION_PTR _PTR_ ppActor
