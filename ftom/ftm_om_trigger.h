...
FTM_RET	FTM_OM_TRIGGERM_create
(
	FTM_OM_TRIGGERM_PTR _PTR_ pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_destroy
(
	FTM_OM_TRIGGERM_PTR _PTR_ pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_init
(
	FTM_OM_TRIGGERM_PTR pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_final
(
	FTM_OM_TRIGGERM_PTR pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_loadConfig
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_CHAR_PTR pFileName
);

FTM_RET	FTM_OM_TRIGGERM_start
(
	FTM_OM_TRIGGERM_PTR pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_stop
(	
	FTM_OM_TRIGGERM_PTR pTriggerM
);

FTM_RET	FTM_OM_TRIGGERM_add
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_TRIGGER_PTR pEvent
);

FTM_RET	FTM_OM_TRIGGERM_del
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_OM_TRIGGER_ID  xEventID
);

FTM_RET	FTM_OM_TRIGGERM_count
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_ULONG_PTR pulCount
);

FTM_RET	FTM_OM_TRIGGERM_get
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_OM_TRIGGER_ID 	xEventID, 
	FTM_OM_TRIGGER_PTR _PTR_ ppEvent
);

FTM_RET	FTM_OM_TRIGGERM_getAt
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_ULONG ulIndex, 
	FTM_OM_TRIGGER_PTR _PTR_ ppEvent
...
FTM_RET	FTM_OM_TRIGGERM_updateEP
(
	FTM_OM_TRIGGERM_PTR pTriggerM, 
	FTM_EP_ID xEPID, 
