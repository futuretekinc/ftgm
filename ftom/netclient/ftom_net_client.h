...
FTM_RET	FTOM_NET_CLIENT_ReadConfig
(
	FTOM_NET_CLIENT_CONFIG_PTR 	pConfig, 
	FTM_CHAR_PTR 			pFileName
);

FTM_RET	FTOM_NET_CLIENT_setConfig
(
	FTOM_NET_CLIENT_PTR			pClient,
	FTOM_NET_CLIENT_CONFIG_PTR	pConfig
);
...
FTM_RET	FTOM_NET_CLIENT_loadConfig
(
	FTOM_NET_CLIENT_PTR	pClient,
	FTM_CONFIG_PTR		pConfig
);
...
FTM_RET	FTOM_NET_CLIENT_sendMessage
(
	FTOM_NET_CLIENT_PTR		pClient,
	FTOM_MSG_PTR			pMsg
);
