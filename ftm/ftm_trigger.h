...
FTM_RET	FTM_TRIGGER_createAbove(FTM_TRIGGER_ID xID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pData, FTM_TRIGGER_PTR _PTR_ ppTrigger); 
FTM_RET	FTM_TRIGGER_createBelow(FTM_TRIGGER_ID xID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pData, FTM_TRIGGER_PTR _PTR_ ppTrigger); 
FTM_RET	FTM_TRIGGER_createInclude(FTM_TRIGGER_ID xID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pUpper, FTM_EP_DATA_PTR pLower, FTM_TRIGGER_PTR _PTR_ ppTrigger); 
FTM_RET	FTM_TRIGGER_createExcept(FTM_TRIGGER_ID xID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pUpper, FTM_EP_DATA_PTR pLower, FTM_TRIGGER_PTR _PTR_ ppTrigger); 
FTM_RET	FTM_TRIGGER_createChange(FTM_TRIGGER_ID xID, FTM_EP_ID xEPID, FTM_TRIGGER_PTR _PTR_ ppTrigger);
...
FTM_RET	FTM_TRIGGER_get(FTM_TRIGGER_ID xID, FTM_TRIGGER_PTR _PTR_ ppTrigger);
...
FTM_RET	FTM_TRIGGER_conditionToString(FTM_TRIGGER_PTR pTrigger, FTM_CHAR_PTR pBuff, FTM_ULONG ulLen);
