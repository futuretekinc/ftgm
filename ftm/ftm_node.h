...
#define	FTM_NODE_FIELD_OPTION			(1 << 6)	
#define	FTM_NODE_FIELD_SNMP_VERSION		(1 << 7)	
#define	FTM_NODE_FIELD_SNMP_URL			(1 << 8)	
#define	FTM_NODE_FIELD_SNMP_COMMUNITY	(1 << 9)	
#define	FTM_NODE_FIELD_SNMP_MIB			(1 << 10)	
#define	FTM_NODE_FIELD_SNMP_MAX_RETRY	(1 << 11)	
#define	FTM_NODE_FIELD_MQTT_VERSION		(1 << 12)	
#define	FTM_NODE_FIELD_MQTT_URL			(1 << 13)	
#define	FTM_NODE_FIELD_MQTT_TOPIC		(1 << 14)	
#define	FTM_NODE_FIELD_LORA_VERION		(1 << 15)	
#define	FTM_NODE_FIELD_LORA_DEVICE		(1 << 16)	
