...
#define	FTM_NODE_TYPE_VIRTUAL				0x00000006
...
#define	FTM_NODE_FIELD_MODEL			(1 << 1)	
#define	FTM_NODE_FIELD_TYPE				(1 << 2)	
#define	FTM_NODE_FIELD_NAME				(1 << 3)	
#define	FTM_NODE_FIELD_FLAGS			(1 << 4)	
#define	FTM_NODE_FIELD_LOCATION			(1 << 5)	
#define	FTM_NODE_FIELD_INTERVAL			(1 << 6)	
#define	FTM_NODE_FIELD_TIMEOUT			(1 << 7)	
#define	FTM_NODE_FIELD_SNMP_VERSION		(1 << 8)	
#define	FTM_NODE_FIELD_SNMP_URL			(1 << 9)	
#define	FTM_NODE_FIELD_SNMP_COMMUNITY	(1 << 10)	
#define	FTM_NODE_FIELD_SNMP_MIB			(1 << 11)	
#define	FTM_NODE_FIELD_SNMP_MAX_RETRY	(1 << 12)	
...
#define	FTM_NODE_FIELD_MQTT_VERSION		(1 << 13)	
#define	FTM_NODE_FIELD_MQTT_URL			(1 << 14)	
#define	FTM_NODE_FIELD_MQTT_TOPIC		(1 << 15)	
#define	FTM_NODE_FIELD_MQTT				(FTM_NODE_FIELD_MQTT_VERSION | FTM_NODE_FIELD_MQTT_URL | FTM_NODE_FIELD_MQTT_TOPIC)
#define	FTM_NODE_FIELD_LORA_VERION		(1 << 16)	
#define	FTM_NODE_FIELD_LORA_DEVICE		(1 << 17)	
