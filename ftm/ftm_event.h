...
FTM_RET	FTM_EVENT_init(FTM_VOID); FTM_RET	FTM_EVENT_final(FTM_VOID); FTM_RET	FTM_EVENT_createCopy(FTM_EVENT_PTR pSrc, FTM_EVENT_PTR _PTR_ ppEvent); FTM_RET	FTM_EVENT_createAbove(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pData, FTM_EVENT_PTR _PTR_ ppEvent); FTM_RET	FTM_EVENT_createBelow(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pData, FTM_EVENT_PTR _PTR_ ppEvent); FTM_RET	FTM_EVENT_createInclude(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pUpper, FTM_EP_DATA_PTR pLower, FTM_EVENT_PTR _PTR_ ppEvent); FTM_RET	FTM_EVENT_createExcept(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pUpper, FTM_EP_DATA_PTR pLower, FTM_EVENT_PTR _PTR_ ppEvent); FTM_RET	FTM_EVENT_createChange(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EVENT_PTR _PTR_ ppEvent);
