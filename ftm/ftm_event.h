...
FTM_RET	FTM_EVENT_createAnd(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EVENT_ID xEventID1, FTM_EVENT_ID xEventID2, FTM_EVENT_PTR _PTR_ ppEvent);
FTM_RET	FTM_EVENT_createOr(FTM_EVENT_ID xEventID, FTM_EP_ID xEPID, FTM_EVENT_ID xEventID1, FTM_EVENT_ID xEventID2, FTM_EVENT_PTR _PTR_ ppEvent);
