...
FTM_RET FTM_OM_DMC_init(FTM_OM_CONTEXT_PTR pCTX, FTM_OM_DMC_PTR pDMC)
{
	ASSERT(pDMC != NULL);
...
FTM_RET FTM_OM_DMC_final(FTM_OM_DMC_PTR pDMC)
{
	ASSERT(pDMC != NULL);
...
FTM_RET	FTM_OM_DMC_start(FTM_OM_DMC_PTR pDMC)
{
	ASSERT(pDMC != NULL);
...
FTM_RET	FTM_OM_DMC_stop(FTM_OM_DMC_PTR pDMC)
{
	ASSERT(pDMC != NULL);
...
FTM_VOID_PTR	FTM_OM_DMC_process(FTM_VOID_PTR pData)
{
	ASSERT(pData != NULL);
...
FTM_RET	FTM_OM_DMC_setServiceCallback(FTM_OM_DMC_PTR pDMC, FTM_OM_SERVICE_ID xServiceID, FTM_OM_SERVICE_CALLBACK pServiceCB)
{
	ASSERT(pDMC != NULL);
...
FTM_RET	FTM_OM_DMC_notify(FTM_OM_DMC_PTR pDMC, FTM_OM_MSG_PTR pMsg)
{
	ASSERT(pDMC != NULL);
	ASSERT(pMsg != NULL);
...
FTM_RET	FTM_OM_DMC_EP_create(FTM_OM_DMC_PTR pDMC, FTM_EP_PTR pInfo)
{
	ASSERT(pDMC != NULL);
	ASSERT(pInfo != NULL);
...
FTM_RET	FTM_OM_DMC_EP_destroy(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID)
{
	ASSERT(pDMC != NULL);
...
FTM_RET	FTM_OM_DMC_EP_DATA_set(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID, FTM_EP_DATA_PTR pData)
{
	ASSERT(pDMC != NULL);
	ASSERT(pData != NULL);
...
FTM_RET FTM_OM_DMC_EP_DATA_setINT(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID, FTM_ULONG ulTime, FTM_INT nValue)
{
	ASSERT(pDMC != NULL);
...
FTM_RET FTM_OM_DMC_EP_DATA_setULONG(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID, FTM_ULONG ulTime, FTM_ULONG ulValue)
{
	ASSERT(pDMC != NULL);
...
FTM_RET FTM_OM_DMC_EP_DATA_setFLOAT(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID, FTM_ULONG ulTime, FTM_DOUBLE fValue)
{
	ASSERT(pDMC != NULL);
...
FTM_RET	FTM_OM_DMC_EP_DATA_count(FTM_OM_DMC_PTR pDMC, FTM_EP_ID xEPID, FTM_ULONG_PTR pulCount)
{
	ASSERT(pDMC != NULL);
