...
FTM_RET	FTM_OM_EPM_count(FTM_OM_EPM_PTR pEPM, FTM_EP_TYPE xType, FTM_ULONG_PTR pulCount);

FTM_RET FTM_OM_EPM_getIDList(FTM_OM_EPM_PTR pEPM, FTM_EP_TYPE 	xType, FTM_EP_ID_PTR pEPID, FTM_ULONG ulMaxCount, FTM_ULONG_PTR pulCount);

FTM_RET FTM_OM_EPM_get(FTM_OM_EPM_PTR pEPM, FTM_EP_ID xEPID, FTM_OM_EP_PTR _PTR_ ppEP);
FTM_RET FTM_OM_EPM_getAt(FTM_OM_EPM_PTR pEPM, FTM_ULONG ulIndex, FTM_OM_EP_PTR _PTR_ ppEP);
...
FTM_RET	FTM_OM_EP_attach(FTM_OM_EP_PTR pEP, FTM_OM_NODE_PTR pNode);
...
FTM_RET	FTM_OM_EP_getDataType(FTM_OM_EP_PTR pEP, FTM_EP_DATA_TYPE_PTR pType);
...
FTM_RET FTM_OM_EP_setFloat(FTM_OM_EP_PTR pEP, FTM_ULONG ulTime, FTM_DOUBLE fValue);

FTM_RET	FTM_OM_EP_getTriggerCount(FTM_OM_EP_PTR pEP, FTM_ULONG_PTR pulCount);
FTM_RET	FTM_OM_EP_getTriggerAt(FTM_OM_EP_PTR pEP, FTM_ULONG ulIndex, FTM_TRIGGER_ID_PTR pTriggerID);
