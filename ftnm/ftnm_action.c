...
FTM_RET	FTNM_ACTIONM_del(FTNM_ACTIONM_PTR pActionM, FTM_ACTION_ID  xActionID)
{
	FTM_RET			xRet;
	FTNM_ACTION_PTR	pAction;
...
FTM_RET	FTNM_ACTIONM_get(FTNM_ACTIONM_PTR pActionM, FTM_ACTION_ID xActionID, FTNM_ACTION_PTR _PTR_ ppAction)
{
	TRACE_CALL();
