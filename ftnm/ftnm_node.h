...
typedef	FTM_RET		(*FTNM_NODE_SET_EP_DATA)(FTNM_NODE_PTR pNode, FTNM_EP_PTR pEP, FTM_EP_DATA_PTR pData);
...
typedef	struct FTNM_NODE_STRUCT
{
	...
	FTNM_NODE_SET_EP_DATA	fSetEPData;
}	FTNM_NODE;
...
FTM_RET	FTNM_NODE_getEP(FTNM_NODE_PTR pNode, FTM_EP_ID xEPID, FTNM_EP_PTR _PTR_ pEP);
