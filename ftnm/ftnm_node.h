...
typedef	FTM_RET		(*FTNM_NODE_EP_UPDATE)(FTNM_NODE_PTR pNode, FTNM_EP_PTR pEP);
typedef	FTM_RET		(*FTNM_NODE_EP_GET_DATA)(FTNM_NODE_PTR pNode, FTNM_EP_PTR pEP, FTM_EP_DATA_PTR pData);
...
typedef	struct FTNM_NODE_STRUCT
{
	...
	FTNM_NODE_EP_UPDATE		fUpdateEP;
	FTNM_NODE_EP_GET_DATA	fGetEPData;
