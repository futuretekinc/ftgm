...
FTM_RET	FTNM_SRV_init(FTM_VOID);
FTM_RET	FTNM_SRV_final(FTM_VOID);

FTM_RET	FTNM_SRV_create(FTNM_SERVER_PTR _PTR_	ppSRV);
FTM_RET	FTNM_SRV_destroy(FTNM_SERVER_PTR 		pSRV);

FTM_RET	FTNM_SRV_start(FTNM_SERVER_PTR		pSRV);
FTM_RET	FTNM_SRV_stop(FTNM_SERVER_PTR		pSRV);
