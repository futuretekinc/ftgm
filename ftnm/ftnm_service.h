...
typedef	enum
{
	...
	FTNM_SERVICE_DBM,
	FTNM_SERVICE_MQTT_CLIENT
}	FTNM_SERVICE_TYPE, _PTR_ FTNM_SERVICE_TYPE_PTR;


typedef	FTM_ULONG	FTNM_SERVICE_ID;

typedef	FTM_RET	(*FTNM_SERVICE_INIT)(FTNM_CONTEXT_PTR pCTX, FTM_VOID_PTR pData);
...
FTM_RET	FTNM_SERVICE_init(FTNM_CONTEXT_PTR pCTX, FTNM_SERVICE_PTR pServices, FTM_ULONG ulCount);
