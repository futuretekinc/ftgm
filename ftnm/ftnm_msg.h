...
#define	FTNM_MSG_TYPE_MQTT_REQ_TIME_SYNC	(1 << 9)
#define	FTNM_MSG_TYPE_MQTT_REQ_CONTROL		(1 << 10)
#define	FTNM_MSG_TYPE_RULE					(1 << 11)
#else
typedef	enum
{
...
typedef	enum
{
	FTNM_MSG_MQTT_REQ_CONTROL_CMD_OFF,
	FTNM_MSG_MQTT_REQ_CONTROL_CMD_ON,
	FTNM_MSG_MQTT_REQ_CONTROL_CMD_BLINK
}	FTNM_MSG_MQTT_REQ_CONTROL_CMD, _PTR_ FTNM_MSG_MATT_REQ_CONTROL_CMD_PTR;
...
typedef	struct
{
	...
	union
	{
		...
		{
			FTM_CHAR						pID[32];
			FTNM_MSG_MQTT_REQ_CONTROL_CMD	xCmd;
			struct
			{
...
}	FTNM_MSG_MQTT_REQ_CONTROL_PARAMS, _PTR_ FTNM_MSG_MQTT_REQ_CONTROL_PARAMS_PTR;

typedef	struct
{
	FTM_RULE_ID		xRuleID;
	FTM_RULE_STATE	xRuleState;
}	FTNM_MSG_RULE_PARAMS, _PTR_ FTNM_MSG_RULE_PARAMS_PTR;
...
typedef	struct
{
	...
	union
	{
		...
		FTNM_MSG_MQTT_REQ_CONTROL_PARAMS	xMQTTReqControl;
		FTNM_MSG_RULE_PARAMS				xRule;
	}	xParams;
