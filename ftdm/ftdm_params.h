...
typedef	struct
{
	...
	FTM_EVENT			xEvent;
}	FTDM_REQ_EVENT_SET_PARAMS, _PTR_ 	FTDM_REQ_EVENT_SET_PARAMS_PTR;
...
typedef	struct
{
	...
	FTM_RET				xRet;
	FTM_EVENT			xEvent;
}	FTDM_RESP_EVENT_SET_PARAMS, _PTR_	FTDM_RESP_EVENT_SET_PARAMS_PTR;
...
typedef struct	
{
	...
	FTM_ULONG			ulIndex;
	FTM_ULONG			ulCount;
}	FTDM_REQ_EVENT_GET_ID_LIST_PARAMS, _PTR_ 	FTDM_REQ_EVENT_GET_ID_LIST_PARAMS_PTR;
...
typedef	struct
{
	...
	FTM_ULONG			ulCount;
	FTM_ID				pIDs[];
}	FTDM_RESP_EVENT_GET_ID_LIST_PARAMS, _PTR_ FTDM_RESP_EVENT_GET_ID_LIST_PARAMS_PTR;
