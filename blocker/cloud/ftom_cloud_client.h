...
typedef	FTM_RET	(*FTOM_CLOUD_CLIENT_DISCONNECT)
(
	FTOM_CLOUD_CLIENT_PTR	pClient
);

typedef	FTM_RET	(*FTOM_CLOUD_CLIENT_IS_CONNECTED)
(
	FTOM_CLOUD_CLIENT_PTR	pClient,
...
typedef	struct
{
	...
	FTOM_CLOUD_CLIENT_CONNECT		fConnect;
	FTOM_CLOUD_CLIENT_DISCONNECT	fDisconnect;
	FTOM_CLOUD_CLIENT_IS_CONNECTED	fIsConnected;
